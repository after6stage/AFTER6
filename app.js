...
const CONFIG = {
  ...
  // ── ตารางรอบการแสดง ──
  schedule: [
    { id:'w1-fri', week:1, day:'ศุกร์',    date:'11', month:'ก.ย.', year:'2569', dateLabel:'ศุกร์ที่ 11 ก.ย. 2569',    slots:['19:00'] },
    { id:'w1-sat', week:1, day:'เสาร์',   date:'12', month:'ก.ย.', year:'2569', dateLabel:'เสาร์ที่ 12 ก.ย. 2569',   slots:['14:00','19:00'] },
    { id:'w1-sun', week:1, day:'อาทิตย์', date:'13', month:'ก.ย.', year:'2569', dateLabel:'อาทิตย์ที่ 13 ก.ย. 2569', slots:['14:00','19:00'] },
  ],

  ticketTypes: [
    { id:'regular',   name:'บัตรเข้าชมการแสดง', desc:'', price:112, badge:'regular', badgeText:'', available:true },
  ...
  bankAccount: {
    bank:        'ธนาคารกสิกรไทย',
    accountNo:   '233-1-17948-8',
    accountName: 'ณัฐชนน ไพโรจน์ และ นัสรี พุ่มเกื้อ',
    branch:      '',
  },
};
...
function sanitizeCapacityValue(slotKey, rawVal) {
  ...
  if (slotKey === 'w1-fri|19:00' && (num === 80 || num === 82 || num === 83)) return 85;
  if (slotKey === 'w1-fri|19:00' && num === 85) return 85;
